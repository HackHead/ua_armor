export default {
    ...
    delivery: `Предлагаем рассмотреть 3 популярных способа доставки.
...
Больше подходит для жителей крупных городов. Эти компании не всегда работают в отдаленных регионах. `,
    ...
    For the purposes of this Privacy Policy:
        ...
        Company (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to uarmor.
        ...
        Website refers to uarmor, accessible from https://www.uarmor.com
